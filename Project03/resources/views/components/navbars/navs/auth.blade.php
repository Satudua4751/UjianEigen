@props(['titlePage'])
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-md position-sticky blur shadow-blur mt-3 left-auto top-2 z-index-sticky" id="navbarBlur" navbar-scroll="true" data-scroll="true">
