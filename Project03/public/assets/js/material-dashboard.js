...
function sidebarType(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active");
    for (var o, r, d, c = document.querySelector(".sidenav"), s = 0; s < l.length; s++)
    ...
    "bg-transparent" != a && "bg-white" != a || !i ? (r = (o = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (d = r.replace("logo-ct-dark", "logo-ct"),
    o.src = d) : (r = (o = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (d = r.replace("logo-ct", "logo-ct-dark"),
    o.src = d),
    "bg-white" == a && n && (r = (o = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (d = r.replace("logo-ct", "logo-ct-dark"),
    o.src = d)
}
...
function navbarColorOnResize() {
    sidenav && (1200 < window.innerWidth ? referenceButtons.classList.contains("active") && "bg-transparent" === referenceButtons.getAttribute("data-class") ? sidenav.classList.remove("bg-white") : document.querySelector("body").classList.contains("dark-version") || sidenav.classList.add("bg-white") : (sidenav.classList.add("bg-white"),
    sidenav.classList.remove("bg-transparent")))
}
